...
public class ProxyChannelFactory
{
     ...
     */
    public static <E> ProxyChannel<E> createSpscProxy(
        int capacity,
        Class<E> iFace,
     ...
     * @return A proxy channel instance
     */
    public static <E> ProxyChannel<E> createMpscProxy(
        int capacity,
        Class<E> iFace,
        WaitStrategy waitStrategy
    )
     ...
     * @return A proxy channel instance
     */
    public static <E> ProxyChannel<E> createProxy(
        int capacity,
        Class<E> iFace,
        WaitStrategy waitStrategy,
    ...
    private static void implementUserMethods(
        ClassWriter classWriter,
        List<Method> relevantMethods,
    ...
    private static <E> ProxyChannel<E> instantiate(Class<?> proxy, int capacity, WaitStrategy waitStrategy)
    {
        try
        {
            return (ProxyChannel<E>) proxy
                .getDeclaredConstructor(int.class, WaitStrategy.class)
                .newInstance(capacity, waitStrategy);
        }
        catch (Exception e)
        {
    ...
    private static void implementProcess(
    ...
    )
    {
        ...
        methodVisitor
            .visitLocalVariable("impl",
                Type.getType(iFace).getDescriptor(),
                null,
                localScopeStart,
                localScopeEnd,
                localIndexOfImpl);
        methodVisitor
            .visitLocalVariable("limit",
                ...
                localIndexOfLimit);
        methodVisitor
            .visitLocalVariable("loopIndex",
                Type.getType(int.class).getDescriptor(),
                null,
                localScopeStart,
                localScopeEnd,
                localIndexOfLoopIndex);
        methodVisitor
            .visitLocalVariable("rOffset",
                Type.getType(long.class).getDescriptor(),
                null,
                localScopeStart,
                localScopeEnd,
                localIndexOfROffset);
        methodVisitor
            .visitLocalVariable("typeId",
                Type.getType(int.class).getDescriptor(),
                null,
                localScopeStart,
                localScopeEnd,
    ...
    private static void implementBridgeMethod(
        ClassVisitor classVisitor,
        String generatedName,
        String methodName,
        Class<?> returnType,
    ...
    )
    {
        ...
        MethodVisitor methodVisitor = classVisitor
            .visitMethod(Opcodes.ACC_BRIDGE | Opcodes.ACC_SYNTHETIC | Opcodes.ACC_PUBLIC,
                methodName,
    ...
    private static void implementUserMethod(
        Method method,
        ClassVisitor classVisitor,
        int type,
        String generatedName,
    ...
    private static void producerReferenceArrayIndex(
    ...
    private static void consumerReferenceArrayIndex(
        MethodVisitor methodVisitor,
    ...
    private static void writeAcquireWithWaitStrategy(
        MethodVisitor methodVisitor,
        String generatedName,
        Class<? extends ProxyChannelRingBuffer> backendType
    )
    ...
    private static void loadUnsafe(MethodVisitor methodVisitor)
    {
        methodVisitor
            .visitFieldInsn(Opcodes.GETSTATIC,
                Type.getInternalName(UnsafeAccess.class),
                "UNSAFE",
                "L" + Type.getInternalName(Unsafe.class) + ";");
    }
    ...
    private static int parameterTypeUnsafe(MethodVisitor methodVisitor, Class<?> parameterType, boolean write)
    {
        ...
        methodVisitor
            .visitMethodInsn(Opcodes.INVOKEVIRTUAL,
                ...
                write ?
                    ("(" + boolDescriptor + "J" + type.getDescriptor() + ")V") :
                    ("(" + boolDescriptor + "J)" + type.getDescriptor()),
                false);
        return type.getSize();
    }
