...
public class GeneratorUtilsTest
{
    ...
    public void runJCToolsGenerator_surfacesParseFailures() throws Exception
    {
        ...
        catch (IllegalStateException expected)
        {
            ...
            assertTrue("message includes parse problems: " + msg, msg.toLowerCase().contains("problem") || msg.contains("(line")  // JavaParser problem messages typically include "(line N,col M)"
    ...
    public void replaceType_throwsOnUnsupportedVariableDeclaratorParent()
    {
        ...
        VariableDeclarator orphan = new VariableDeclarator(
            new ArrayType(new ClassOrInterfaceType(null, "E")),
            "buffer");
