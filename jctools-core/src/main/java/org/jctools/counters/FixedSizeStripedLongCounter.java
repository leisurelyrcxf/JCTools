...
abstract class FixedSizeStripedLongCounterFields extends FixedSizeStripedLongCounterPrePad
{
    ...
    protected static final long COUNTER_ARRAY_BASE = Math
        .max(UNSAFE.arrayBaseOffset(long[].class), PortableJvmInfo.CACHE_LINE_SIZE - 8);
...
public abstract class FixedSizeStripedLongCounter extends FixedSizeStripedLongCounterFields implements Counter
{
    ...
    private int probe()
    {
        ...
        // As long as PROBE is static final this branch will be constant folded
        // (i.e removed).
        if (PROBE != -1)
        {
            int probe;
