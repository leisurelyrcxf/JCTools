...
public class HandrolledHarness extends Thread
{
    ...
    static Counter make_ctr(final int impl)
    {
        switch (impl)
        {
            ...
            case 6:
                return new StripeLockCounter(8);
            case 7:
                return new StripeUnsafeCounter(8);
            case 8:
                return new StripeLockCounter(64);
            case 9:
                return new StripeUnsafeCounter(64);
            case 10:
                return new StripeLockCounter(256);
            case 11:
                return new StripeUnsafeCounter(256);
            case 12:
                return new CATCounter();
            default:
    ...
    private HandrolledHarness(int tnum, Counter C, long[] ops)
    {
        _tnum = tnum;
        _C = C;
        _ops = ops;
